...
# All supported sports with their RapidAPI endpoints
ENDPOINTS = {
...
# Function to get data for the selected sport
def get_data(sport):
    url = ENDPOINTS[sport]
    host = url.split("/")[2]  # extract host dynamically
    headers = {
...
# Tiny logistic model for quick randomised predictions
def tiny_model():
    s = pd.DataFrame({
